                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <a href="?page=kategoriAdd" button class="btn waves-effect waves-light btn-primary btn-outline-primary">
                                    ...
                                    <tbody id="table-body">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="tooltip" data-placement="top" title="Edit Data" class="btn waves-effect waves-dark btn-success btn-outline-success btn-sm" href="?page=kategoriEdit&id=<?php echo $data['id']; ?>">
