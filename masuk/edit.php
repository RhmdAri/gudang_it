...
if (isset($_GET['id'])) {
    ...
    $query = mysqli_query($con, "SELECT * FROM masuk WHERE id = '$id'");
    $data = mysqli_fetch_array($query);

    // Ambil ID Petugas dan ID Barang untuk digunakan dalam form
...
if (isset($_POST['submit'])) {
    ...
    // Update data
    $update = mysqli_query($con, "UPDATE masuk SET idPetugas = '$idPetugas', idBarang = '$idBarang', jumlah = '$jumlah' WHERE id = '$id'");
    ...
    if ($update) {
        ...
        echo "Gagal memperbarui data masuk";
    }
}
?>
