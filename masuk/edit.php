...
$query = "SELECT * FROM masuk WHERE id = ? AND devisi = ?";
...
if (isset($_POST['update'])) {
    ...
    if ($jumlahBaru > 0) {
        ...
        $updateQuery = "UPDATE masuk SET idPetugas = ?, idBarang = ?, jumlah = ? WHERE id = ? AND devisi = ?";
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit Barang Masuk</h5>
                    </div>
                </div>
                <div class="col-md-4">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Edit Barang Masuk</a></li>
                    </ul>
                </div>
            </div>
        </div>
