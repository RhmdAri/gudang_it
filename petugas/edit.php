...
if (isset($_POST['submit'])) {
    ...
    if (!empty($nama) && !empty($jabatan)) {
        if ($status == 'disetujui' || $status == 'menunggu') {
            $update = mysqli_query($con, "UPDATE petugas SET nama='$nama', jabatan='$jabatan', status='menunggu' WHERE id=$id");
            ...
            if ($update) {
                echo "<script>
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil',
                        text: 'Perubahan petugas berhasil disimpan dan menunggu persetujuan Administrator!'
                    }).then(() => {
                        window.location.href = '?page=petugas';
                    });
                </script>";
            ...
            echo "<script>
                Swal.fire({
                    icon: 'warning',
                    title: 'Perubahan Menunggu Persetujuan',
                    text: 'Perubahan Anda masih menunggu persetujuan Administrator.'
                });
            </script>";
        }
    } else {
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Edit Petugas</h5>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form class="form-material" method="POST" id="editPetugasForm">
                                    ...
                                    <div class="form-group form-default">
                                        <input type="text" class="form-control" name="jabatan" value="<?php echo htmlspecialchars($jabatan); ?>" required>
                                        <span class="form-bar"></span>
